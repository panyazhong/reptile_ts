...
var Crowller = /** @class */ (function () {
    function Crowller(url, analyzer) {
        ...
        this.filePath = path_1.default.resolve(__dirname, '../data/article.json');
        this.initProcess();
    }
    ...
    Crowller.prototype.initProcess = function () {
        return __awaiter(this, void 0, void 0, function () {
            var text, articlesJSON;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getRawHtml()];
                    case 1:
                        text = _a.sent();
                        articlesJSON = this.analyzer.analyze(text, this.filePath);
...
var analyzer = cnodeAnalyzer_1.default.getInstance();
